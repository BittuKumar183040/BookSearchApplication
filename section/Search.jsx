...
const Search = ({ setBooks, setLoading }) => {
      ...
      <div className=" dark:text-white my-10">
        ...
        <div className=" flex justify-center">
          <button
            ...
            className="mt-4 flex items-center gap-2 w-fit pl-3 p-2 px-4 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300 transition duration-200 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-400"
          >
            <HiPlus size={22} />
